...
MetPalettes <- list(
    ...
    Cassatt = list(c("#b1615c", "#d88782", "#e3aba7", "#edd7d9", "#c9c9dd", "#9d9dc7", "#8282aa", "#5a5a83"), c(3, 6, 1, 8, 4, 5, 2, 7), colorblind=TRUE),
    Cross = list(c("#c969a1", "#ce4441", "#ee8577", "#eb7926", "#ffbb44", "#859b6c", "#62929a", "#004f63", "#122451"), c(4, 7, 1, 8, 2, 6, 3, 5, 9), colorblind=FALSE),
    Degas = list(c("#591d06", "#96410e", "#e5a335", "#556219", "#418979", "#2b614e", "#053c29"), c(5, 2, 4, 3, 7, 1, 6), colorblind=FALSE),
    ...
    Hokusai = list(c("#6d2f20", "#b75347", "#df7e66", "#e09351", "#edc775", "#94b594", "#224b5e"), c(2, 7, 4, 6, 5, 1, 3), colorblind=FALSE),
    ...
    Nattier = list(c("#52271c", "#944839", "#c08e39", "#7f793c", "#565c33", "#184948", "#022a2a"), c(1, 6, 5, 2, 3, 4, 7), colorblind=FALSE),
    ...
    Pissaro = list(c("#134130", "#4c825d", "#8cae9e", "#8dc7dc", "#508ca7", "#1a5270", "#0e2a4d"), c(5, 2, 3, 6, 4, 7, 1), colorblind=FALSE),
    ...
    Robert = list(c("#11341a", "#375624", "#6ca4a0", "#487a7c", "#18505f", "#062e3d"), c(3, 2, 4, 5, 1, 6), colorblind=FALSE),
...
#'
#' @export
colorblind_palettes <- c("Cassatt", "Egypt", "Greek", "Ingres", "Isfahan1", "Isfahan2", "Morgenstern", "Pillement", "Troy", "Veronese")
...
colorblind.friendly <- function(palette.name){
  ...
  if (palette.name %notin% names(MetPalettes)) {
    stop("Palette does not exist.")
  }

  friendly <- palette.name %in% colorblind_palettes
